...
receipt set contains only **143.4
minutes**, and the selected corrected session contains **105.5
minutes**. These are an early diagnostic, not a 24-hour acceptance result.

The corrected session emitted **85 raw
...
**84 first-leg episodes**:
**55 natural maker pairs** and
**29 `unpaired_age` forced closes**.

Natural maker completion was
**65.48%**, below the empirical
break-even requirement of
**93.08%**. Strategy-native
realized contribution was
**-377.480c**; the raw engine counter was
**-384.540c**, including
...
| 7 | 2026-07-26T05:39:06.710270Z | 60.0 | 85 | -384.540c | True |
...
85. Counter continuity establishes the
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| natural maker | 55 | 62.000c | 1.127c | 1.000c | 1.000c | 2.000c | 3.872s | 44.521s |
| unpaired-age forced | 29 | -439.480c | -15.154c | -37.880c | -11.350c | -3.120c | 60.455s | 60.949s |
...
- Source snapshot cutoff: `2026-07-26T07:24:35.108489Z`
- Source files: 3
- Parsed receipts: 8006
