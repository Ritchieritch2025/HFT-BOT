...
| PLAN_SPORTS_TRADING_MASTER.md | **ACTIVE**(策略权威,规划-only) | 十站单一通路(数据→四瓶颈→TRAIN/VALIDATION/CONFIRMATION→影子→微实盘);统一 MM_ROADMAP/TEST_PROGRAM/MASTER_SEQUENCE/deep03,非干预,不改任何门/代码/生产 |
