...
**Stage 0 实测更新(2026-07-11 22:44Z probe,门 (c) 达成)**:48 市场晚间
最热窗口(世界杯+MLB 赛中)实测 **694.5 msg/s、B/msg=530**(§2.3 估计
531 精确命中);60% 流量来自 8 个赛中 Soccer 市场——**赛中≫赛前直接
证实**,本数字是"全赛中"上界(若持续 ≈31.8 GB/天),赛前为主的 Stage 1
真实量级预期显著更低。L3(48 市场单订阅)、L6(双连接共存)实测通过。
完整表与判读:PLAN_DEPTH_EXPANSION §8。Stage 1 出口时用 48h 实采数据
重算 Stage 2 磁盘账。
