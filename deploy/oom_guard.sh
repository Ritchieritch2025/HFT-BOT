...
#  -1000  ws_shadow  (capture is NEVER the OOM victim; a dead capture is the
#         one non-recoverable loss on this box — raw data has no second source)
#
...
# capture: pin to -1000 (exempt from OOM killer)
