...
WORK_PACKAGE = "D3-W2A"
W2A_RELEASE_ID = "D3-W2A-2026-07-19.11"
...
def validate_authority_bundle(
    *,
    ...
    if w0_release_id != W0_RELEASE_ID:
        raise AuthorityError("W0 release ID differs from the fixed .11 release")
    if w1_release_id != W1_RELEASE_ID:
        raise AuthorityError("W1 release ID differs from the fixed .11 release")
