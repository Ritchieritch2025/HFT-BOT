...
def test_base_inventory_refuses_legacy_rfq_capability(receipt_tree):
    with pytest.raises(cr.ReceiptError, match="RFQ_OVERLAY_REQUIRED"):
        cr.build_desired_inventory(
